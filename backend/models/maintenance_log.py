...
class MaintenanceLogCreate(BaseModel):
    ...
    mileage: int = Field(..., ge=0, strict=True, description="Odometer reading at the time of service")
    ...
    interval_miles: int | None = Field(None, gt=0, strict=True)
...
class MaintenanceLogUpdate(BaseModel):
    ...
    mileage: Optional[int] = Field(None, ge=0, strict=True, description="Odometer reading at the time of service")
    ...
    interval_miles: Optional[int] = Field(None, gt=0, strict=True, description="Interval in miles for next reminder")
