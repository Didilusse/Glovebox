...
describe('initialization and guards', () => {
  ...
  it('accepts normalized usernames and preserves password whitespace at boundaries', () => {
    expect(validateCredentials(' Alice ', '    ', 1)).toBe('')
    expect(validateCredentials('abc', 'x'.repeat(11))).toContain('12-128')
    expect(validateCredentials('abc', 'x'.repeat(12))).toBe('')
    expect(validateCredentials('abc', 'x'.repeat(128))).toBe('')
    expect(validateCredentials('abc', 'x'.repeat(129))).toContain('12-128')
